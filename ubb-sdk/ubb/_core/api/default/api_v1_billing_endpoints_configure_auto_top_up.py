...
from ...models.configure_auto_top_up_request import ConfigureAutoTopUpRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/billing/customers/{customer_id}/auto-top-up".format(customer_id=quote(str(customer_id), safe=""),),
    }
