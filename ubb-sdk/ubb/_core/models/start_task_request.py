...
T = TypeVar("T", bound="StartTaskRequest")
...
class StartTaskRequest:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, StartTaskRequestMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> None | StartTaskRequestMetadataType0 | Unset:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = StartTaskRequestMetadataType0.from_dict(data)
                ...
                pass
            return cast(None | StartTaskRequestMetadataType0 | Unset, data)
        ...
        start_task_request.additional_properties = d
        return start_task_request
