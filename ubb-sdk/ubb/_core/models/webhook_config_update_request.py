...
T = TypeVar("T", bound="WebhookConfigUpdateRequest")
...
class WebhookConfigUpdateRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhook_config_update_request = cls(
        ...
        webhook_config_update_request.additional_properties = d
        return webhook_config_update_request
