...
from ..models.tenant_supplied_revenue_out_recognition_method import TenantSuppliedRevenueOutRecognitionMethod
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="TenantSuppliedRevenueOut")



@_attrs_define
class TenantSuppliedRevenueOut:
    """ One supplied record, as the tenant stated it.
        ...
        Attributes:
            ...
            id (str):
            period_start (str):
            recognition_method (TenantSuppliedRevenueOutRecognitionMethod):
            recorded_at (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recognition_method = TenantSuppliedRevenueOutRecognitionMethod(d.pop("recognition_method"))
        ...
        tenant_supplied_revenue_out = cls(
            amount_micros=amount_micros,
            currency=currency,
            id=id,
            period_start=period_start,
        ...
        tenant_supplied_revenue_out.additional_properties = d
        return tenant_supplied_revenue_out
