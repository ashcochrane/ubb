...
class BalanceResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        negative_since: None | str | Unset
        if isinstance(self.negative_since, Unset):
            negative_since = UNSET
        else:
        ...
        if negative_since is not UNSET:
            field_dict["negative_since"] = negative_since
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_negative_since(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        negative_since = _parse_negative_since(d.pop("negative_since", UNSET))
