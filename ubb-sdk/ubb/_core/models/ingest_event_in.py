...
T = TypeVar("T", bound="IngestEventIn")
...
class IngestEventIn:
    ...
    the ingest request/response schemas are independently versionable.
        ...
        Attributes:
            ...
            usage_metrics (IngestEventInUsageMetricsType0 | None | Unset):
     """
    ...
    usage_metrics: IngestEventInUsageMetricsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.tags, Unset):
            tags = UNSET
        elif isinstance(self.tags, IngestEventInTagsType0):
        ...
        if isinstance(self.usage_metrics, Unset):
            usage_metrics = UNSET
        elif isinstance(self.usage_metrics, IngestEventInUsageMetricsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_metadata,  Unset):
            ...
            metadata = IngestEventInMetadata.from_dict(_metadata)
        ...
        def _parse_tags(data: object) -> IngestEventInTagsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                tags_type_0 = IngestEventInTagsType0.from_dict(data)
                ...
                pass
            return cast(IngestEventInTagsType0 | None | Unset, data)
        ...
        def _parse_usage_metrics(data: object) -> IngestEventInUsageMetricsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                usage_metrics_type_0 = IngestEventInUsageMetricsType0.from_dict(data)
                ...
                pass
            return cast(IngestEventInUsageMetricsType0 | None | Unset, data)
        ...
        ingest_event_in.additional_properties = d
        return ingest_event_in
