...
AUDIT_ACTION_TENANT_DEFAULT_MARKUP_DECLARED = 'tenant_default_markup.declared'
AUDIT_ACTION_TENANT_DEFAULT_MARKUP_WITHDRAWN = 'tenant_default_markup.withdrawn'
AUDIT_ACTION_PRICING_BOOK_PUBLISH_DECLARED = 'pricing_book_publish.declared'
AUDIT_ACTION_PRICING_BOOK_PUBLISH_PUBLISHED = 'pricing_book_publish.published'
AUDIT_ACTION_PRICING_BOOK_PUBLISH_DISCARDED = 'pricing_book_publish.discarded'
AUDIT_ACTION_PRICING_BOOK_DECLARED = 'pricing_book.declared'
AUDIT_ACTION_PRICING_BOOK_WITHDRAWN = 'pricing_book.withdrawn'
AUDIT_ACTION_COST_BOOK_DECLARED = 'cost_book.declared'
AUDIT_ACTION_COST_BOOK_WITHDRAWN = 'cost_book.withdrawn'
AUDIT_ACTION_CUSTOMER_PRICING_OVERRIDE_DECLARED = 'customer_pricing_override.declared'
AUDIT_ACTION_CUSTOMER_PRICING_OVERRIDE_WITHDRAWN = 'customer_pricing_override.withdrawn'
AUDIT_ACTION_RESOLUTION_RUN_EXECUTED = 'resolution_run.executed'
...
AUDIT_ACTION_EVENT_TYPE_PUBLISHED = 'event_type.published'
AUDIT_ACTION_MEASUREMENT_WITHDRAWN = 'measurement.withdrawn'
AUDIT_ACTION_REPORTED_COST_MAPPING_DECLARED = 'reported_cost_mapping.declared'
AUDIT_ACTION_REPORTED_COST_MAPPING_WITHDRAWN = 'reported_cost_mapping.withdrawn'
AUDIT_ACTION_PROVIDER_DECLARED = 'provider.declared'
AUDIT_ACTION_PROVIDER_RETIRED = 'provider.retired'
AUDIT_ACTION_EVENT_CATEGORY_DECLARED = 'event_category.declared'
AUDIT_ACTION_EVENT_CATEGORY_WITHDRAWN = 'event_category.withdrawn'
...
AUDIT_ACTION_VALUES = frozenset({
    ...
    AUDIT_ACTION_TENANT_DEFAULT_MARKUP_DECLARED,
    AUDIT_ACTION_TENANT_DEFAULT_MARKUP_WITHDRAWN,
    AUDIT_ACTION_PRICING_BOOK_PUBLISH_DECLARED,
    AUDIT_ACTION_PRICING_BOOK_PUBLISH_PUBLISHED,
    AUDIT_ACTION_PRICING_BOOK_PUBLISH_DISCARDED,
    AUDIT_ACTION_PRICING_BOOK_DECLARED,
    AUDIT_ACTION_PRICING_BOOK_WITHDRAWN,
    AUDIT_ACTION_COST_BOOK_DECLARED,
    AUDIT_ACTION_COST_BOOK_WITHDRAWN,
    AUDIT_ACTION_CUSTOMER_PRICING_OVERRIDE_DECLARED,
    AUDIT_ACTION_CUSTOMER_PRICING_OVERRIDE_WITHDRAWN,
    AUDIT_ACTION_RESOLUTION_RUN_EXECUTED,
    ...
    AUDIT_ACTION_EVENT_TYPE_PUBLISHED,
    AUDIT_ACTION_MEASUREMENT_WITHDRAWN,
    AUDIT_ACTION_REPORTED_COST_MAPPING_DECLARED,
    AUDIT_ACTION_REPORTED_COST_MAPPING_WITHDRAWN,
    AUDIT_ACTION_PROVIDER_DECLARED,
    AUDIT_ACTION_PROVIDER_RETIRED,
    AUDIT_ACTION_EVENT_CATEGORY_DECLARED,
    AUDIT_ACTION_EVENT_CATEGORY_WITHDRAWN,
...
# removed it. It had no uniqueness constraint, no lookup, no filter and no read
...
# kind never had one. Three answers where a reader previously met one empty bag
# and could not tell which of them it meant — which is how a payload that
...
#   facts, and a summary sentence above the values is not beside them. Read the
#   kind first — a posting that never had measurements is not a posting that
#   has lost them.
#
...
#        omission. This is the answer the whole concept exists to make sayable,
#        and reporting it as an empty result is the defect.

MEASUREMENTS_STATUS_AVAILABLE = 'available'
MEASUREMENTS_STATUS_PRUNED = 'pruned'
MEASUREMENTS_STATUS_NOT_APPLICABLE = 'not_applicable'

MEASUREMENTS_STATUS_VALUES = frozenset({
...
REASON_CODE_ABSOLUTE_DEADLINE = 'absolute_deadline'
REASON_CODE_PARENT_EXPIRED = 'parent_expired'
