...
class TestHistoricalPricing:
    def test_backdated_event_prices_on_superseded_card_version(self):
        ...
        t, c = _setup()
        now = timezone.now()
        v1 = rate_in_default_book(t, measurement_key="tok",
        ...
        v2 = rate_in_default_book(t, measurement_key="tok", lineage_id=v1.lineage_id,
            rate_structure="per_unit", rate_per_unit_micros=50, unit_quantity=1,
