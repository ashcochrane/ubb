...
| **Authoring** (you) | `python openapi/contract_gate.py --baseline main --emit` | generates *your* new entries only, so a slice does not re-derive every earlier one |
...
conflate them, and do not "tidy" a suppression file toward zero.
