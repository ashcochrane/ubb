...
// ⚠ **THE STORED AXIS WAS A VALUE THE SERVER NOW REFUSES (#508).** This
// fixture held `product_id` — a bare word with no kind, from the free-text
// shape #503 replaced — and since that ticket the PUT validates the stored
// value against the tenant's own discovery contract and rejects a word that
// names no axis. So the fixture had stopped describing a reachable state: mock
