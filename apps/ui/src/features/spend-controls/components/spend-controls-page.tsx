// /spend-controls — the Spend controls tab (#466; slice 6 §18 Q6).
//
...
// workspace's enforcement posture and hosts Stops and breaches, tenant-wide,
// with a customer and a family filter — and, from ticket 16, Utilisation and
// headroom beside it. It is ungated: the four spend controls sit on a kernel
// concept, and a family a workspace lacks answers no rows.
//
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        description="What each spend control stopped, and what still landed past it."
        actions={
          <DateRangePicker
